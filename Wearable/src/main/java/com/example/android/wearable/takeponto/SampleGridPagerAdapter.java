...
public class SampleGridPagerAdapter extends FragmentGridPagerAdapter {
    ...
    private static String TAG = "TAKE_TIME_CARD_WEARABLE";
    private static String PUSH_IN = "/push_in";
    private static String PUSH_OUT = "/push_out";
    ...
    public SampleGridPagerAdapter(Context ctx, FragmentManager fm, GoogleApiClient mGoogleApiClient) {
        super(fm);
        mContext = ctx;
        ...
        mRows.add(
            new Row(
                    ...
                    ActionFragment.create(R.drawable.sign_in, R.string.push_in, new ActionFragment.Listener() {
                        @Override
                        public void onActionPerformed() {
                            Log.i("WEAR", "Frag1");
                            sendMessageToCompanion(PUSH_IN);
                        }
                    }),
                    ActionFragment.create(R.drawable.sign_out, R.string.push_out, new ActionFragment.Listener() {
                        @Override
                        public void onActionPerformed() {
                            Log.i("WEAR", "Frag2");
                            sendMessageToCompanion(PUSH_OUT);
                        }
                    })
        ...
        mDefaultBg = new ColorDrawable(R.color.black);
        mClearBg = new ColorDrawable(android.R.color.black);
    }


    private void sendMessageToCompanion(final String path) {
        Wearable.NodeApi.getConnectedNodes(_mGoogleApiClient).setResultCallback(
                new ResultCallback<NodeApi.GetConnectedNodesResult>() {
                    @Override
                    public void onResult(NodeApi.GetConnectedNodesResult getConnectedNodesResult) {
                        for (final Node node : getConnectedNodesResult.getNodes()) {
                            Wearable.MessageApi.sendMessage(_mGoogleApiClient, node.getId(), path,
